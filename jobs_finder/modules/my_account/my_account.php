...
<script language="javascript" type="text/javascript" src="<?php echo JQUERY_PATH;?>"></script>
<script language="javascript" type="text/javascript" src="<?php echo PROTOTYPE_PATH;?>"></script>
<script language="javascript" type="text/javascript" src="<?php echo JQUERY_PATH_2;?>"></script>
<script language="javascript" type="text/javascript" src="<?php echo JQUERY_PATH_3;?>"></script>
